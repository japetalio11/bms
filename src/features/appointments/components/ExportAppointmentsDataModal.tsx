...
export function ExportAppointmentsDataModal({
  ...
  const handleExport = () => {
    ...
    link.setAttribute(
      "download",
      `Appointments_Export_${new Date().toISOString().slice(0, 10)}.csv`
    )
          ...
          >
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="af1" className="text-xs font-normal">
                ...
                <span className="text-muted-foreground">- Sheet document</span>
              </Label>
            </div>
          </RadioGroup>
        </div>
          ...
          <RadioGroup defaultValue="filtered" className="gap-3">
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="as1" className="text-xs font-normal">
                <span className="text-foreground">Current Filtered View</span>{" "}
                <span className="text-muted-foreground">
